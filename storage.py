...
class RolloutStorage(object):
    def __init__(self, num_steps, num_processes, obs_shape, action_space, state_size):
        # self.observations = torch.zeros(num_steps + 1, num_processes, *obs_shape).long()
        self.observations = torch.zeros(num_steps + 1, num_processes).long()
        # print('obs size', self.observations.size())
